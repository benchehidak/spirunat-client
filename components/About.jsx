...
export default function TimelineSection() {
  ...
  return (
    <section
      className="bg-cover bg-center bg-fixed py-20 min-h-screen"
      ...
      <div className="container mx-auto px-6 lg:px-20">
        ...
        <div className="text-center text-white mb-16">
          <h2 className="text-4xl md:text-5xl font-extrabold mb-4">
            LES LABORATOIRES <span className="text-[#1e3f35]">SPIRUNAT</span>
          </h2>
        ...
        <div className="relative">
          {/* Central Line */}
          <div className="absolute left-4 md:left-1/2 md:-translate-x-1/2 translate-x-0 h-full w-1 bg-[#1e3f35]" />
          ...
          <div className="space-y-12 md:space-y-24">
            {timelineEvents.map((event, index) => (
              ...
              >
                  ...
                  >
                    <h3
                      className={`text-2xl font-bold mb-2 ${
                        event.highlight ? "text-white" : "text-black"
                      }`}
                    >
                      {event.year}
                    </h3>
                    <h4
                      className={`text-xl font-semibold mb-3 ${
                        event.highlight ? "text-slate-200" : "text-gray-600"
                      }`}
                    >
                      {event.title}
                    </h4>
                ...
                {/* Center Point */}
                <div className="absolute left-4 md:left-1/2 transform md:-translate-x-1/2 -translate-x-1/2 w-4 h-4 bg-[#1e3f35] rounded-full border-4 border-white" />
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="mt-24 text-white text-center">
          <h3 className="text-3xl font-bold mb-8">Nos Valeurs Fondamentales</h3>
