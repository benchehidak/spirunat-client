...
export function BigNav({ totalCartItems }) {
  ...
  return (
    <div className="lg:sticky lg:top-0 lg:z-[10] flex flex-col sm:flex-row items-center justify-between px-4 py-3 bg-white shadow-md ">
      <div className="flex justify-between items-center w-1/2 ">
        <div className="flex items-center my-2">
          <img
            ...
            alt="BIOMARKET"
          />
          <h1 className="text-2xl font-semibold">BIOARKET</h1>
        </div>
      </div>
      <div className="flex justify-between w-full p-2 ">
        ...
        <div className="flex items-center flex-wrap">
          <div className=" absolute top-[31px]  right-[70px] " >

            <Link className="mr-4" size="icon" href="/shop-cart" variant="ghost">
              <IconShoppingCart className="h-6 w-6m items-center " />
          ...
          <Sheet >
            ...
            <SheetContent side="right">
              <nav className="flex flex-col gap-4 p-4 text-lg font-medium">
                ...
                <Link className="text-gray-700 hover:text-gray-900" href="/account">
                  Account
                </Link>
                <Link className="text-gray-700 hover:text-gray-900" href="#">
                  Contact Us
